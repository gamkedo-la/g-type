...
const textStrings = {
    ...
    Contributors: [
{name:"H Trayford",   works: ['project lead','core functionality','scoring and score pop ups','powerup objects','enemy, projectile, and collision code','level 2 and 3 design','screenshake','menu base code','checkpoint and continues','enemy pathing','cut scene animations','ground enemy integration','main UI integration','missile, ghost, and clear powerups','boss behavior improvements','boss explosions','all flying and two ground enemy art','volcano','bug fixes'] },
...
{name:"Jeff \"Axphin\" Hanlon",   works: ['main story writing','player ship sprite (including turns)','mini boss sprite','game font','thruster sprites','original player art','main menu selector', 'planet sprite', 'QA testing'] },
{name:"Jaime Rivas",   works: ['explosion animation','shot flash effect','powerup refactoring','clear screen powerup','laser shot artwork'] },
...
{name:"Randy Tan Shaoxian",   works: ['text scroll support', 'cutscene code', 'level skip cheat (disabled)','WASD input code','improved keyboard support', 'pause screen layout', 'credits layout'] },
{name:"Michelly Oliveira",   works: ['credits pause/play with space','extra life sound integration','powerups cheat (disabled)','ghost ship explosion hookups', 'music loop support','auto-fire on options screen', 'demo scene movement'] },
...
{name:"K. Anthony",   works: ['powerups spawn code','powerup increment feature', 'powerup buttons hookup (disabled)'] },
...
{name:"Praneil Kamat",   works: ['HQ invasion eyeboss behavior'] },
...
{name:"Kevin Pavlish",   works: ['shields cheat (disabled)','pause screen improvements'] },
