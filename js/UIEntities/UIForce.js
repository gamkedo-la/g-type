...
function UIForce(position = {x:0, y:0}) {
    ...
    const lightSprite = new AnimatedSprite(lightForceUI, 2, 50, 50, true, true, {min:0, max:0}, 0, {min:0, max:1}, 1536, {min:1, max:1}, 0);
    const darkSprite = new AnimatedSprite(darkForceUI, 2, 50, 50, true, true, {min:0, max:0}, 0, {min:0, max:1}, 2048, {min:1, max:1}, 0);
